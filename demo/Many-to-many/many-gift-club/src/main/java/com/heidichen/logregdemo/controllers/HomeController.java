...
public class HomeController {
	...
	@PutMapping("/gifts/{id}/like")
	public String likeGift(@PathVariable("id")Long giftId, HttpSession session) {
		Long userId = (Long) session.getAttribute("userId");
		mainService.likeGift(giftId, userId);
		
		return "redirect:/home";
	}
	
	@PutMapping("/gifts/{id}/unlike")
	public String unlikeGift(@PathVariable("id")Long giftId, HttpSession session) {
		Long userId = (Long) session.getAttribute("userId");
		mainService.unlikeGift(giftId, userId);
